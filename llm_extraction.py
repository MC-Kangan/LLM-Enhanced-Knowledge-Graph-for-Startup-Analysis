...
if __name__ == "__main__":
    ...
    if not client:
        scrape_file_path = f'{os.getenv("fintech_scraping_folder")}/{processed_name}.json'
        summary_file_path = f'{os.getenv("fintech_summary_folder")}/{processed_name}_summary_str.json'
        extraction_file_path = f'{os.getenv("fintech_extraction_folder")}/{processed_name}_extraction.json'
        ...
        scrape_file_path = f'{os.getenv("client_scraping_folder")}/{processed_name}.json'
        summary_file_path = f'{os.getenv("client_summary_folder")}/{processed_name}_summary_str.json'
